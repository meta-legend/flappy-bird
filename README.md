...
it, and run **Flappy_Bird** — no installation needed (Windows, Linux, macOS).

## How to play

1. On the title screen, **type your name** and press **Enter** to start.
2. **Flap** with **Space**, **W**, **Up arrow**, or **left mouse button**.
3. Avoid the pipes — the game speeds up the longer you survive.
...
Made by **Pranab Shukla** (meta_legend). Built with raylib.
